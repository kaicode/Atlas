    ...
    function routes(appModel) {
      return {        
        '/cohortdefinitions': () => {
          ...
          require(['cohort-definitions', 'cohort-definition-manager', 'components/cohort-definitions/cohort-definition-browser'], function () {
        ...
        '/cohortdefinition/:cohortDefinitionId:/?((\w|.)*)': (cohortDefinitionId, path) => {
          appModel.activePage(this.title);
          require(['cohortbuilder/CohortDefinition', 'components/atlas.cohort-editor', 'cohort-definitions', 'cohort-definition-manager', 'components/cohort-definitions/cohort-definition-browser', 'conceptset-editor', 'report-manager', 'explore-cohort', 'conceptset-list-modal'], function (CohortDefinition) {
        ...
        '/cohortdefinition/:cohortDefinitionId/conceptset/:conceptSetId/:mode:': (cohortDefinitionId, conceptSetId, mode) => {
          appModel.activePage(this.title);
          require(['report-manager', 'cohortbuilder/CohortDefinition', 'components/atlas.cohort-editor', 'cohort-definitions', 'cohort-definition-manager', 'components/cohort-definitions/cohort-definition-browser', 'conceptset-editor', 'explore-cohort'], function (CohortDefinition) {
            appModel.componentParams = {
              model: appModel
            };
            appModel.currentView('cohort-definition-manager');
        ...
        '/reports': () => {
          appModel.activePage(this.title);
          require(['report-manager', 'cohort-definition-manager', 'components/cohort-definitions/cohort-definition-browser'], function () {
            appModel.componentParams = {
              model: appModel
            };
